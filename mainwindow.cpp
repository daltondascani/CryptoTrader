...
{
    // Creating if statements to handle valid/invalid input //
    ...
    //else case to display error for invalid input //
    else
    {
        QMessageBox mb;
...
void MainWindow::updateCryptoSell(double Sellinput, QString cryptoSelection)
{
    ...
    if (cryptoSelection == "Bitcoin" && Sellinput <= btc)
    {
        ...
        //Message box displaying a successful sale//
        QMessageBox mb;
...
//when button is clicked, opens web page for coinmarketcap //
